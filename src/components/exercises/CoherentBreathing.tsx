...
const PHASE_DURATION = 5000; // 5 seconds each
const TOTAL_CYCLES = 6;

export function CoherentBreathing({ onBack, onComplete }: ExerciseProps) {
  ...
  return (
    <ExerciseBackground exerciseId="coherent-breathing" variant="gradient">
        ...
        <AnimatePresence mode="wait">
          {!isComplete ? (
            ...
            >
              ...
              <motion.div
                className="w-36 h-36 sm:w-48 sm:h-48 rounded-full mx-auto mb-10 sm:mb-12"
                style={{
              ...
              >
                <motion.div
                  ...
                  style={{
                    background: "radial-gradient(circle, hsl(168 30% 68% / 0.3) 0%, transparent 70%)",
                  }}
                  animate={{
                    scale: phase === "inhale" ? [0.7, 1] : [1, 0.7],
                  }}
                  transition={{
                    duration: 5,
                    ease: "easeInOut",
  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-muted-foreground mb-8">
        Your heart and breath are in harmony.
      </p>
